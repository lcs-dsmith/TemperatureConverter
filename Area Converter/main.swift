...
let startingSystem = String.collectInput(withPrompt: "What is your destination system? ", acceptableValues: ["mm", "cm", "m", "km", "in", "ft", "yrd", "mi"])

let valueToComvert = Int.collectInput(withPrompt: "What is the value you want to convert? ", minimum: 0, maximum: nil)
